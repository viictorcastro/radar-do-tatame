  ...
  return (
    <div className="rounded-xl border border-dashed border-neutral-300 bg-white p-4 text-center dark:border-neutral-700 dark:bg-neutral-900">
      ...
      <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
        Anuncie aqui e alcance a comunidade de Jiu-Jitsu.
      </p>
      <button
        type="button"
        onClick={handleClick}
        className="mt-3 rounded-full border border-neutral-300 px-3 py-1.5 text-xs font-medium text-neutral-600 transition hover:bg-neutral-50 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800"
      >
        Fale conosco
      </button>
    </div>
  ...
  return (
    <div className="rounded-xl border border-green-200 bg-green-50 p-4 text-center dark:border-green-900 dark:bg-green-950/40">
      <div className="flex items-center justify-center gap-1.5 text-green-700 dark:text-green-400">
        ...
        <p className="text-sm font-semibold">Mantenha-se informado</p>
      </div>
      ...
      <span className="mt-3 inline-block rounded-full bg-green-200/60 px-3 py-1 text-xs font-medium text-green-800 dark:bg-green-900/50 dark:text-green-300">
        Em breve
      </span>
    </div>
  );
